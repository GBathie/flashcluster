...
def compute_clustering(
    points: np.ndarray, c: float, method: Literal["fast", "precise"]
) -> Ultrametric:
    """
    ...
    :param method: "fast": may under-estimate the distance in some cases, but performs better.
...
class Ultrametric:
    ...
    """
    def __init__(
        self, points: np.ndarray, c: float, method: Literal["fast", "precise"]
    ) -> None: ...
